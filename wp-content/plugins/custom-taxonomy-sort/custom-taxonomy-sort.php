...
class CustomTaxonomySort {
	...
	?>
		<div class="form-field">
			<label for="tax-order"><?php _e( 'Thứ tự', $this->plugin_name ) ?></label>
			<input name="tax-order" id="tax-order" type="text" value="" size="40" aria-required="true" />
			<p class="description"><?php _e( 'Xác định thứ tự hiển thị.', $this->plugin_name ); ?></p>
		</div>
	<?php
	} 	
	...
	function column_header( $columns ) {
		$columns['order'] = __( 'Thứ tự', $this->plugin_name );
		return $columns;
	}
