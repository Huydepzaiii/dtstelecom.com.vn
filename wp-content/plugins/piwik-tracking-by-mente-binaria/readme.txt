...
Tags: matomo, analytics, statistics, tracking, code
...
This unofficial, simple plugin helps you add a tracking code for Matomo to your WordPress website, for an easier integration.

== Description ==

This unofficial, simple plugin helps you add a tracking code for Matomo to your WordPress website, for an easier integration.

For more information about Matomo, visit [matomo.org](https://matomo.org/).
...
1. Install and activate the plugin as you normally would. (You can find more details and instructions [here](https://wordpress.org/support/article/managing-plugins/).)
2. Visit the "Tracking code for Matomo" page in the "Settings" section and adjust the parameters. Don't forget to click "Save Changes" when you're done.
...
Perhaps. Please file a bug report [here](https://wordpress.org/support/plugin/piwik-tracking-by-mente-binaria/) and i will look into it as soon as possible.
...
I'm giving you this plugin because others worked to give us WordPress for free - i'm just giving something back.

= This plugin is pretty cool. How can i repay you? =

Thanks! If you'd like to give something back, visit [this page](https://wordpress.org/support/article/contributing-to-wordpress/) to see how you can contribute to WordPress.
...
= 1.1.3 =
* Made several adjustments to improve compliance with WordPress.org's trademark policies.
* Made minor adjustments to code comments.
